 ...
 * build output directories, so attribution falls back to "threadtearer"/"unknown";
...
public final class ModResolver {
    ...
    private String resolve(String className) {
        ...
        if (className.startsWith("com.taolesi.threadtearer")) {
            return "threadtearer";
        }
        if (className.startsWith("net.minecraftforge.") || className.startsWith("net.neoforged.")) {
            return "neoforge";
        }
        try {
