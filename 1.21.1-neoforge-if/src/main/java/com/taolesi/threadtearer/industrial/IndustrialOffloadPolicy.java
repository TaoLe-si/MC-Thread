 ...
 *       {@code onFinish()}): Dissolution Chamber (recipe lookup reads the
 *       recipe manager, the same immutable-map read Mekanism's cached recipes
 *       do), Latex Processing Unit, Dye Mixer, Fermentation Station, Fluid
 *       Sieving Machine, Washing Factory, Sewage Composter, Spores
 *       Recreator, Material StoneWork Factory, Potion Brewer, Enchantment
 *       Sorter, Resourceful Furnace ({@code registryAccess()} only),
 *       Enchantment Extractor ({@code EnchantmentHelper} is static over the
 *       machine's own stacks).</li>
 ...
 *       sequences.</li>
 *   <li><b>Refused — entity scans and area work.</b> Everything extending
 *       {@code IndustrialAreaWorkingTile} (Plant Sower/Gatherer/Fertilizer,
 *       Animal Feeder/Rancher/Baby Separator, Mob Crusher/Duplicator,
 *       Slaughter Factory, Sewer, Block Breaker/Placer, Fluid
 *       Collector/Placer, Mechanical Dirt, Marine Fisher, Laser Drill,
 *       Hydroponic Bed, Wither Builder, Fluid Extractor, Mob Detector,
 *       Stasis Chamber) and Infinity Charger: AABB entity scans, block
 *       placement/removal, fake-player interaction.</li>
